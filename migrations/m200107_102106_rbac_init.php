 ...
 * @since 2.0
 */
class m200107_102106_rbac_init extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $this->insert('auth_item', [
            "name" => "admin",
            "type" => 1,
            "description"=>"admin can create products and create sold_products",
        ]);

        $this->insert('auth_item', [
            "name" => "create-product",
            "type" => 1,
            "description"=>"allow a user to add a product",
        ]);

        $this->insert('auth_item', [
            "name" => "create-sold_products",
            "type" => 1,
            "description"=>"allows user to create a sold_products",
        ]);
